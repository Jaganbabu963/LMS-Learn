  ...
  const fetchCurrentCourseProgress = async () => {
    ...
    if (response?.success) {
      ...
      if (response?.data?.progress?.length === 0) {
        ...
        setCurrentLecture(
          response?.data?.courseDetails?.curriculam[lastIndexOfViewedAsTrue + 1]
        );
    ...
    <div className="flex flex-col h-screen bg-[#1c1d1f] text-white">
      ...
      <Dialog open={lockCourse}>
        <DialogContent className="sm:w-[425px]">
          <DialogHeader>
            <DialogTitle>You can&lsquo;t view this page</DialogTitle>
            <DialogDescription>
...
export default CourseProgresPage;
